...
(function () {
  ...
  var NAV_HTML = ''
    ...
    +             '<a href="' + ASSET_PREFIX + 'programme-tahfiz-academique.html" class="flex items-center gap-3 px-4 py-3 hover:bg-secondary/5"><div class="w-9 h-9 bg-secondary/10 rounded-lg flex items-center justify-center"><i class="fas fa-book-open text-secondary text-sm"></i></div><div><p class="font-semibold text-slate-800 text-sm" data-i18n="programs.combined">Tahfiz + Académique</p><p class="text-xs text-slate-500">Coran + Français + Anglais</p></div></a>'
    ...
    +       '<a href="' + ASSET_PREFIX + 'programme-tahfiz-academique.html" data-route="programs" class="block py-2 pl-4 text-sm" data-i18n="programs.combined">Tahfiz + Académique</a>'
  ...
  var FOOTER_HTML = ''
    ...
    +           '<li><a href="' + ASSET_PREFIX + 'programme-tahfiz-academique.html" data-i18n="programs.combined">Tahfiz + Académique</a></li>'
