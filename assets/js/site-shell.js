...
(function () {
  ...
  var NAV_HTML = ''
    ...
    +             '<a href="' + ASSET_PREFIX + 'programme-al-mouslihoon"     class="flex items-center gap-3 px-4 py-3 hover:bg-pink-50"><div class="w-9 h-9 bg-pink-100 rounded-lg flex items-center justify-center"><i class="fas fa-venus text-pink-600 text-sm"></i></div><div><p class="font-semibold text-slate-800 text-sm flex items-center gap-2">Al-Mouslihoon <span style="font-size:9px;text-transform:uppercase;letter-spacing:.06em;background:#fef3c7;color:#b45309;font-weight:800;padding:2px 7px;border-radius:9999px;">Bientôt</span></p><p class="text-xs text-slate-500">Programme féminin · Internat &amp; Externat</p></div></a>'
    ...
    +         '<span style="line-height:1.25;"><span class="aaa-dlink-title" style="display:flex;align-items:center;gap:6px;font-size:14px;font-weight:600;">Al-Mouslihoon <span style="font-size:9px;text-transform:uppercase;letter-spacing:.06em;background:#fef3c7;color:#b45309;font-weight:800;padding:2px 7px;border-radius:9999px;">Bientôt</span></span><span style="font-size:11px;color:#94a3b8;">Programme féminin · Internat &amp; Externat</span></span>'
    +       '</a>'
    /* Camp — mis en avant */
  ...
  var FOOTER_HTML = ''
    ...
    +           '<li><a href="' + ASSET_PREFIX + 'programme-al-mouslihoon">Al-Mouslihoon <span style="font-size:9px;text-transform:uppercase;background:#fef3c7;color:#b45309;font-weight:800;padding:1px 6px;border-radius:9999px;margin-left:4px;">Bientôt</span></a></li>'
