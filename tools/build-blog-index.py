...
{jsonld()}
  ...
  <style>
    ...
    .aaa-filter-count {{
      font-size: .75rem; font-weight: 700; opacity: .75;
      background: rgba(15,23,42,.08); border-radius: 9999px; padding: 0 .4rem;
    }}
    .aaa-filter.is-active .aaa-filter-count {{ background: rgba(255,255,255,.2); }}
